              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        '${NumberFormat('###,###,###,###').format((orderItem.isNotEmpty && orderItem.first.actualPaymentByOrder! > 0) ? orderItem.first.actualPaymentByOrder : (orderItem.fold(0, (e, v) => e + v.payAmount!)))} 원',
                        style: const TextStyle(
